...
Сам клиент сервиса — в siquester/stats_api.py.
"""
from __future__ import annotations

from . import stats_api as _stats_api
...
def fetch(name: str, authors: list[str]):
    ...
    summary — как stats_api.summarize(): started/completed/rate.
    ...
    ОТВЕЧЕННЫХ попыток, а не среди всех показов.
    """
    import requests
